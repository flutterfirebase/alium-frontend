  ...
  return (
    <StyledCakeStats>
      <CardBody>
        ...
        <Divider />
        <Row>
          <Text fontSize="16px" color="#8990A5" style={{ fontWeight: "normal" }}>{TranslateString(536, 'Total ALM Supply')}</Text>
          <CardValue fontSize="16px" color="#0B1359" bold value={totalSupply} />
        </Row>
        <Row>
          <Text fontSize="16px" color="#8990A5">{TranslateString(538, 'Total ALM Burned')}</Text>
          <CardValue fontSize="16px" color="#0B1359" value={getBalanceNumber(burnedBalance)} />
        </Row>
        <Row>
          <Text fontSize="16px" color="#8990A5">{TranslateString(540, 'New ALM/block')}</Text>
