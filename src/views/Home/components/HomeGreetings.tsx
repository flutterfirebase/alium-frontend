...
const HomeGreetings: React.FC = () => {
  ...
  return (
    <GreetingsWrapper>
        <GreetingsConfetti />
        <InfoWrapper>
            <StyledHeading className="animate__animated animate__fadeInUp animate__delay-2s animate__fast ">{t('hurray')}!</StyledHeading>
            <StyledText className="animate__animated animate__fadeInUp animate__delay-2s animate__fast">{t('greetingsMessage')}</StyledText>
            <a href={process.env.REACT_APP_START_TO_TRADE} className="animate__animated animate__fadeInUp animate__delay-2s animate__fast">
        ...
        <ImageFrapper>
            ...
            <Lottie
                loop={false}
                animationData={greetingsAnimationJSON}
                play
